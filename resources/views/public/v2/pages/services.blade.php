...
<section id="pricing" class="pricing">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 text-center" style="margin-top: 16vh;">
            ...
            <div class="col-lg-3 col-md-6 mt-4 mt-md-0">
                <div class="box">
                    ...
                    {{-- <div class="btn-wrap">
                        <a href="{{route('star.tokens.order')}}" class="btn-buy">Upgrade</a>
                    </div> --}}
                </div>
            </div>

            {{-- <div class="col-lg-1 col-md-3 text-center" style="margin-top: 16vh;">
                <span> *OR </span>
            </div> --}}
        ...
        <div class="text-center mt-5 small text-muted">
            <p>*Only one (1) paid subscription can be availed at a time.</p>
            <p>**Must register their Charitable Organization first before they can avail of any paid subscription.</p>
            <p>***Subscription will revert back to <strong>Free</strong> after subscription period expires.</p>
        </div>
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="faq-list">
            ...
            <li data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-2" class="collapsed">What are Star Tokens? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                <div id="faq-list-2" class="collapse" data-parent=".faq-list">
                    <p>
                        Star Tokens refer to the main currency used in the <strong>CAVIOM</strong> platform.
                        ...
                        the <strong>FREE</strong> Star Tokens or purchase prepaid star tokens. Here are features that require Star Tokens:
                    </p>
                    <p>Create 1 Featured Project — 450</p>
                    <p>Unlock 1 Associate Accounts — 1,500</p>
                    <p>Create 1 Gift Giving Project — 300</p>
                </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-3" class="collapsed">How much are Prepaid Star Tokens? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                <div id="faq-list-3" class="collapse" data-parent=".faq-list">
                <p>₱29 — 600 Star Tokens</p>
                <p>₱59 — 1,500 Star Tokens</p>
                <p>₱109 — 3,000 Star Tokens</p>
                </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-4" class="collapsed">How do I avail of any of Subscription / Star Tokens? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-5" class="collapsed">Can I change my mind after I ordered? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-6" class="collapsed">Are my Charitable Organization's records safe? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="100">
                <i class="bx bx-help-circle icon-help"></i> <a data-toggle="collapse" href="#faq-list-7" class="collapsed">Where can I ask my questions? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
