                    ...
                    <div class="card-body">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <!-- Full Name Form Group -->
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <!-- Form type -->
                                                        <input type="hidden" name="form_type" id="form_type" value="redirectToViewAfterAdd" />
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="fam_middle_name" id="fam_middle_name"
                                                                       value="{{ old('fam_middle_name') }}">
                                                    ...
                                                    <div class="form-group mb-3 row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control" name="fam_birth_date" id="fam_birth_date" type="date" required
                                                                       value="{{ old('fam_birth_date') }}">
                        ...
                        <div class="row p-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <a href="{{ route('charity.beneficiaries3.createPart3', $beneficiary->code) }}" class="btn btn-dark btn-rounded w-md waves-effect waves-light float-end">
                                            Go to the next part <i class="ri-arrow-right-fill"></i>
                                        </a>
