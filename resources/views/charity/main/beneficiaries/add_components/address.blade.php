...
<div class="form-group mb-3 row">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" id="permanent_region" value="{{ old('permanent_region') }}"></select>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select class="form-control" id="permanent_province" value="{{ old('permanent_province') }}"></select>
...
<div class="form-group mb-3 row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input class="form-control" name="permanent_postal_code" id="permanent_postal_code" type="number" required
                value="{{ old('permanent_postal_code') }}" placeholder="Must be 4 digits">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input class="form-control" name="present_postal_code" id="present_postal_code" type="number" required
                   value="{{ old('present_postal_code') }}" placeholder="Must be 4 digits">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input class="form-control" name="provincial_postal_code" id="provincial_postal_code" type="number" required
                   value="{{ old('provincial_postal_code') }}" placeholder="Must be 4 digits">
