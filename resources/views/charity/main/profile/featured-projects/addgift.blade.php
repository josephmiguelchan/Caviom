            ...
            <div class="col-12">
                <div class="card p-4">
                    <div class="card-body">
                        ...
                        <form action="{{route('charity.profile.feat-project.add.gift.store')}}" id="add_form" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name"
                                        value="{{old('name') ?? $giftgiving->name}}" placeholder="Enter name of the project">
                                    @error('name')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="started_on" id="started_on"
                                                value="{{old('started_on') ?? Carbon\Carbon::parse($giftgiving->start_at)->isoFormat('YYYY-MM-DD')}}" placeholder="Enter date of the activity">
                                            @error('started_on')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" name="total_beneficiaries" id="total_beneficiaries"
                                                value="{{old('total_beneficiaries') ?? $giftgiving->GiftGivingBeneficiaries->count()}}" min="1" max="1000" placeholder="Choose between 1 to 1000...">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="sponsors" id="sponsors"
                                                value="{{old('sponsors') ?? $giftgiving->sponsors}}" placeholder="Enter sponsors...">
                                            @error('sponsors')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="venue" id="venue"
                                                value="{{ old('objective') ?? $giftgiving->venue }}" placeholder="Enter venue of the project...">
                                            @error('venue')
                                            <div class="text-danger">
                                                {{ $message }}
                                            </div>
                            ...
                            <div class="form-group mb-5 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="elm1" rows="7" name="objective" placeholder="Enter your project's objective/s..."
                                        maxlength="500">
                                        <p class="mt-4">
                                            {{ old('objective') ?? $giftgiving->objective }}
                                        </p>
