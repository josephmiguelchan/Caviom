                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mx-3">
                                        ...
                                        <p class="card-text my-0 mb-3">
                                            <i class="ri-checkbox-blank-circle-fill font-size-10 text-success align-middle me-2"></i> 1 Completed Tasks
                                        </p>
                                    </div>
                                        <p class="card-text">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mx-3">
                                        ...
                                        <p class="card-text my-0 mb-3">
                                            <i class="ri-checkbox-blank-circle-fill font-size-10 text-success align-middle me-2"></i> 31 Completed Tasks
                                        </p>
                                        </div>
                                        <p class="card-text">
                                            <small class="text-muted">Last updated 3 mins ago</small>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mx-3">
                                        ...
                                        <p class="card-text my-0 mb-3">
                                            <i class="ri-checkbox-blank-circle-fill font-size-10 text-success align-middle me-2"></i> 53 Completed Tasks
                                        </p>
                                        </div>
                                        <p class="card-text">
                                            <small class="text-muted">Last updated 3 mins ago</small>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mx-3">
                                        ...
                                        <p class="card-text my-0 mb-3">
                                            <i class="ri-checkbox-blank-circle-fill font-size-10 text-success align-middle me-2"></i> 21 Completed Tasks
                                        </p>
                                        </div>
                                        <p class="card-text">
                                            <small class="text-muted">Last updated 3 mins ago</small>
