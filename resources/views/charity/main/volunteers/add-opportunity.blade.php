                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4 mt-4">
                                    <a href="{{route('charity.volunteers.all')}}" class="text-link float-end">
                                        <i class="ri-arrow-left-line"></i> Go Back
                                    </a>
                                </div>
                            </div>
                            <hr class="my-3">
                            <form method="POST" action="{{ route('charity.volunteers.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group mb-3 row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="cel_no" id="cel_no" type="tel" value="{{ old('cel_no') }}"
