<ol>
    ...
    <p>
        Welcome to Caviom (“Company”, “we”, “our”, “us”)! These Terms of Service (“Terms”, “Terms of Service”) govern your
        use of our website located at https://caviom.org/ (together or individually “Service”) operated by Caviom. Our Privacy
        Policy also governs your use of our Service and explains how we collect, safeguard, and disclose information that
        results from your use of our web pages. Your agreement with us includes these Terms and our Privacy Policy
        (“Agreements”).
    </p>
    <p>
        You acknowledge that you have read and understood Agreements, and agree to be bound of them. If you
        do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let us know by
        emailing <a href="mailto:support@caviom.org">support@caviom.org</a> so we can try to find a solution. These Terms apply
        to all visitors, users, and others
        who wish to access or use the Service.
    </p>

    <h6><li class="fw-bold">Communications</h6></li>
    <p>
        By using our Service, you agree to subscribe to marketing or promotional materials, and other information we may send.
        However, you may opt-out of receiving any, or all, of these communications from us by following the unsubscribe link or
        by emailing at <a href="mailto:support@caviom.org">support@caviom.org</a>.
    </p>

    <h6><li class="fw-bold">Purchases</h6></li>
    <p>
        If you wish to purchase any product or service made available through Service (“Purchase”), you may be asked to supply
        certain information relevant to your Purchase including proof of purchase such as a receipt or reference number of
        transaction given. By submitting your information, you grant us the right to provide the information to these third
    ...
    <h6><li class="fw-bold">Contests, Sweepstakes, and Promotions</h6></li>
    <p>
    ...
    <h6><li class="fw-bold">Refunds</h6></li>
    <p>
        Any services purchased in Caviom are non-refundable.
    </p>

    <h6><li class="fw-bold">Content</h6></li>
    <p>
    ...
    <p>
        ...
        You agree that this license includes the right for us to make your Content available to other users of Service, who
        may also use your Content subject to these Terms.
    </p>
    <p>
        Caviom has the right but not the obligation to monitor and edit all Content provided by users.
    </p>
    <p>
        In addition, Content found on or through this Service is the property of Caviom or used with permission. You may
    ...
    <h6><li class="fw-bold">Prohibited Uses</h6></li>
    <p>
        ...
        <ol>
            ...
            <li>
                To impersonate or attempt to impersonate any company, charity organization, a charity organization's employee,
    ...
    <h6><li class="fw-bold">No Use By Minors</h6></li>
    <p>
    ...
    <h6><li class="fw-bold">Accounts</h6></li>
    <p>
    ...
    <p>
        ...
        activities or actions that occur under your account and/or password, whether your password is with our Service or
        a third-party service. You must notify us immediately upon becoming aware of any breach of security or unauthorized
        use of your account.
    </p>
    <p>
    ...
    <h6><li class="fw-bold">Intellectual Property</h6></li>
    <p>
        Service and its original content (excluding Content provided by users), features, and functionality are and will
        remain the exclusive property of Caviom and its licensors. Service is protected by copyright, trademark, and other laws
        of foreign countries. Our trademarks may not be used in connection with any product or service without the prior written
        consent of Caviom.
    </p>

    <h6><li class="fw-bold">Copyright Policy</h6></li>
    <p>
    ...
    <p>
        ...
        <a href="mailto:support@caviom.org">support@caviom.org</a>, with the subject line: “Copyright Infringement” and include
        in your claim a detailed description of the alleged Infringement as detailed below, under “DMCA Notice and Procedure
    ...
    <h6><li class="fw-bold">DMCA Notice and Procedure for Copyright Infringement Claims</h6></li>
    <p>
    ...
    <p>
        You can contact our Copyright Agent via email at <a href="mailto:support@caviom.org">support@caviom.org</a>.
    </p>

    <h6><li class="fw-bold">Error Reporting and Feedback</h6></li>
    <p>
        You may provide us either directly at <a href="mailto:support@caviom.org">support@caviom.org</a> or via third-party
        sites and tools with information and feedback concerning errors, suggestions for improvements, ideas, problems,
        complaints, and other matters related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall
        not retain, acquire or assert any intellectual property right or other rights, title, or interest in or to the
        Feedback; (ii) Company may have developed ideas similar to the Feedback; (iii) Feedback does not contain confidential
        information or proprietary information from you or any third party; (iv) Company is not under any obligation of
        confidentiality with respect to the Feedback. In the event the transfer of the ownership to the Feedback is not
        possible due to applicable mandatory laws, you grant Company and its affiliates an exclusive, transferable, irrevocable,
        free-of-charge, sub-licensable, unlimited, and perpetual right to use (including copy, modify, create derivative works,
        publish, distribute and commercialize) Feedback in any manner and for any purpose.
    </p>

    <h6><li class="fw-bold">Links To Other Web Sites</h6></li>
    <p>
        Our Service may contain links to third-party websites or services that are not owned or controlled by Caviom.
    </p>
    <p>
        Caviom has no control over and assumes no responsibility for the content, privacy policies, or practices of any
        third-party websites or services. We do not warrant the offerings of any of these entities/individuals or their
        websites.
    </p>
    <p>
        YOU ACKNOWLEDGE AND AGREE THAT THE COMPANY SHALL NOT BE RESPONSIBLE OR LIABLE, DIRECTLY OR INDIRECTLY, FOR ANY DAMAGE
        OR LOSS CAUSED OR ALLEGED TO BE CAUSED BY OR IN CONNECTION WITH THE USE OF OR RELIANCE ON ANY SUCH CONTENT, GOODS, OR
        SERVICES AVAILABLE ON OR THROUGH ANY SUCH THIRD PARTY WEB SITES OR SERVICES.
    </p>
    <p>
        WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND PRIVACY POLICIES OF ANY THIRD-PARTY WEBSITES OR SERVICES THAT
        YOU VISIT.
    </p>

    <h6><li class="fw-bold">Disclaimer of Warranty</h6></li>
    <p>
        THESE SERVICES ARE PROVIDED BY THE COMPANY ON AN “AS IS” AND “AS AVAILABLE” BASIS. THE COMPANY MAKES NO REPRESENTATIONS
        OR WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, AS TO THE OPERATION OF THEIR SERVICES, OR THE INFORMATION, CONTENT, OR
    ...
    <p>
        NEITHER COMPANY NOR ANY PERSON ASSOCIATED WITH THE COMPANY MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE
        COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, OR AVAILABILITY OF THE SERVICES. WITHOUT LIMITING THE FOREGOING,
        NEITHER COMPANY NOR ANYONE ASSOCIATED WITH THE COMPANY REPRESENTS OR WARRANTS THAT THE SERVICES, THEIR CONTENT, OR ANY
    ...
    <p>
        ...
        INCLUDING BUT NOT LIMITED TO ANY WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, AND FITNESS FOR A PARTICULAR PURPOSE.
    </p>
    <p>
        THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW.
    </p>

    <h6><li class="fw-bold">Limitation Of Liability</h6></li>
    <p>
        ...
        IF THERE IS LIABILITY FOUND ON THE PART OF THE COMPANY, IT WILL BE LIMITED TO THE AMOUNT PAID FOR THE PRODUCTS AND/OR
    ...
    <h6><li class="fw-bold">Termination</h6></li>
    <p>
    ...
    <h6><li class="fw-bold">Governing Law</h6></li>
    <p>
        These Terms shall be governed and construed in accordance with the laws of the Philippines, which governing law applies
        to the agreement without regard to its conflict of law provisions.
    </p>
    <p>
        ...
        replace any prior agreements we might have had between us regarding Service.
    </p>

    <h6><li class="fw-bold">Changes To Service</h6></li>
    <p>
        ...
        at any time or for any period. From time to time, we may restrict access to some parts of the Service, or the entire
        Service, to users, including registered users.
    </p>

    <h6><li class="fw-bold">Amendments To Terms</h6></li>
    <p>
    ...
    <h6><li class="fw-bold">Waiver And Severability</h6></li>
    <p>
    ...
    <h6><li class="fw-bold">Acknowledgement</h6></li>
    <p>
